...
xvfb-run -a ~/casa-pipeline-release-5.6.2-3.el7/bin/casa --rcdir ../.casa --nologger --nogui --log2term --nocrashreport --pipeline -c ReductionPipeline/lband_pipeline/line_pipeline.py 20A-346.sb38098105.eb38158028.58985.68987263889.speclines.ms
